...
# FusionPBX Settings
domain_name=fs.local                        # hostname, ip_address or a custom value
system_username=admin                       # default username admin
system_password=password                    # random or a custom value
...
database_password=password                  # random or a custom value (safe characters A-Z, a-z, 0-9)
